...
{
    public partial class FoodBank : Form
    {
        public static bool egyptianfoodbank=false;
        ...
        {
            string Org5Email = "egyptianfoodbank@gmail.org";
            egyptianfoodbank = true;
            Pay pay = new Pay(Org5Email);
            pay.Show();
            this.Hide();
        }
        ...
        {
            UC_home_org5 uC = new UC_home_org5();
            addUserControl(uC);
        }

        private void about_btn_Click(object sender, EventArgs e)
        {
            UC_about_org5 uC = new UC_about_org5();
            addUserControl(uC);
        }
