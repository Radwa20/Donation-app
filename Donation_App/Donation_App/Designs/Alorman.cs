...
{
    public partial class Alorman : Form
    {
        public static bool alorman = false;
        ...
        {
            string Org3Email = "alorman@gmail.org";
            alorman = true;
            Pay pay = new Pay(Org3Email);
            pay.Show();
            this.Hide();
        }
        ...
        private void home_btn_Click(object sender, EventArgs e)
        {
            ...
            UC_home_org3 uC = new UC_home_org3();
            addUserControl(uC);
        }

        private void about_btn_Click(object sender, EventArgs e)
        {
            UC_about_org3 uC = new UC_about_org3();
            addUserControl(uC);
        }

        private void back_tn_Click_1(object sender, EventArgs e)
        {
