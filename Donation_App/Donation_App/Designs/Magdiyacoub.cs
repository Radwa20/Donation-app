...
{
    public partial class Magdiyacoub : Form
    {
        public static bool magdiyacoub=false;
        ...
        {
            string Org6Email = "magdiyacoub@gmail.org";
            magdiyacoub = true;
            Pay pay = new Pay(Org6Email);
            pay.Show();
            this.Hide();
        }
        ...
        {
            UC_home_org6 uC = new UC_home_org6();
            addUserControl(uC);
        ...
        {
            UC_about_org6 uC = new UC_about_org6();
            addUserControl(uC);
        }
