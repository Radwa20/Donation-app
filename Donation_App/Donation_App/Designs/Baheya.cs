...
{
    public partial class Baheya : Form
    {
        public static bool  baheya=false;
        ...
        {
            string Org2Email = "baheya@gmail.org";
            baheya = true;
            Pay pay = new Pay(Org2Email);
            pay.Show();
            this.Hide();
        }
        ...
        {
            UC_home_org2 uC = new UC_home_org2();
            addUserControl(uC);
        }

        private void about_btn_Click(object sender, EventArgs e)
        {
            UC_about_org2 uC = new UC_about_org2();
            addUserControl(uC);
        }
